...
//V2.5 20140307
//1,修改LCD_RD_DATA和LCD_ReadPoint读取的bug.
//2,新增ASCII 24*24字体的支持(更多字体用户可以自行添加)
//3,添加LCD_WR_DATAXX函数,替代 LCD_WR_DATA函数,以时间换空间,从而节省flash占用量.
//4,新增NT35510（ID:5510）驱动器的支持
//////////////////////////////////////////////////////////////////////////////////	 
